...
* Remove the plug from the servo, then solder the wires to the Arduino Nano as shown in the wiring diagram below (red to 5V*, Black to Ground, Yellow to any PWM pin)
